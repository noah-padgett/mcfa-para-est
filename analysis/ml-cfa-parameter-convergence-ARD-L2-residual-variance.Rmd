---
title: "Average Relative Difference Among Parameter Estimates: Level-2 Residual Variance"
date: "2020-06-10"
...
wide_res <- filter(wide_res, Parameter %like% "thetaB")
...
p <- ggplot(ard.est, aes(x=Comparison, y=ARD)) +
  ...
  labs(y="Average Relative Difference",
       x=NULL,
       title="ARD: Level-2 Residual Variance")+
  theme_bw()+
