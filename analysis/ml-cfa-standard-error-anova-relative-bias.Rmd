---
title: "Design Effects on Standard Error Relative Bias Estimates"
date: "2020-06-01"
...
This is done using analysis of variance (factorial) on the estimates of relative bias (RB) for the standard Error.
...
kable(tb, format='html') %>%
   kable_styling(full_width = T) %>%
   add_header_above(c('Effect'=1,'Factor Loadings'=1,'Level-1 Factor Covariance'=1,'Level-2 Factor (co)variance'=1,'Level-2 Item Residual Variance'=1))

## Print out in tex
print(xtable(tb, digits = 2), booktabs = T, include.rownames = T)
# 
# 
# ## Table of omega-2
