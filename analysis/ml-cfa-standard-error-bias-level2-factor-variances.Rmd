---
title: "ML-CFA: Standard Error Bias - Level-2 Factor Variances"
...
p1 <- ggplot(sdat, aes(y=estMean))+
  geom_boxplot()+
  labs(y="Average Level-2 Factor Variance SE")

p2 <- ggplot(sdat, aes(y=estSD))+
  geom_boxplot()+
  labs(y="SD of Level-2 Factor Variances SE")
...
p <- (p1 + p2 + p3)/(p4 + p5 + p6) + 
  plot_annotation(title="Summarizing bias indices of LEVEL-2 FACTOR VARIANCE Standard Error")
p
...
ggplot(sdat, aes(y=estMean))+
  geom_boxplot()+
  labs(y="Average Level-2 Factor Variance SE",
       title="LEVEL-2 FACTOR VARIANCE SE by Estimation Method",
       subtitle="SE Estimates")+
  facet_wrap(.~Estimator)

ggplot(sdat, aes(y=estSD))+
  geom_boxplot()+
  labs(y="SD of Level-2 Factor Variances",
       title="LEVEL-2 FACTOR VARIANCE SE by Estimation Method",
...
kable(c, format='html', digits=4,
      caption="Summary Indices of LEVEL-2 FACTOR VARIANCE Standard Error by Estimation Method") %>%
...
ggplot(sdat, aes(y=estMean))+
  geom_boxplot()+
  labs(y="Average Level-2 Factor Variance",
       title="LEVEL-2 FACTOR VARIANCE SE by Level-2 Sample Size",
       subtitle="Estimates")+
  facet_wrap(.~N2)
...
ggplot(sdat, aes(y=RB))+
  ...
  geom_hline(yintercept=10, color="red", linetype="dashed")+
  labs(y="Relative Bias",
       title="LEVEL-2 FACTOR VARIANCE by Level-2 Sample Size",
...
kable(c, format='html', digits=3, 
      caption="Summary Indices of LEVEL-2 FACTOR VARIANCE by Level-2 Sample Size") %>%
  kable_styling(full_width = T)
...
ggplot(sdat, aes(y=estMean))+
  geom_boxplot()+
  labs(y="Average Level-2 Factor Variance",
       title="LEVEL-2 FACTOR VARIANCE by Level-1",
       subtitle="SE Estimates")+
  facet_wrap(.~N1)
...
ggplot(sdat, aes(y=estSD))+
  geom_boxplot()+
  labs(y="SD of Level-2 Factor Variances",
       title="LEVEL-2 FACTOR VARIANCE by Level-1 Sample Size",
       subtitle="Standard Deviation of SE Estimates")+
  facet_wrap(.~N1)
...
kable(c, format='html', digits=3,
      caption="Summary Indices of LEVEL-2 FACTOR VARIANCE  by Level-1 Sample Size") %>%
  kable_styling(full_width = T)
...
ggplot(sdat, aes(y=estMean))+
  geom_boxplot()+
  labs(y="Average Level-2 Factor Variance",
       title="LEVEL-2 FACTOR VARIANCE by ICC of Observed Variables",
       subtitle="SE Estimates")+
  facet_wrap(.~ICC_OV)
...
kable(c, format='html', digits=3, caption="Summary Indices of LEVEL-2 FACTOR VARIANCE by ICC of Observed Variables") %>%
  kable_styling(full_width = T)
...
ggplot(sdat, aes(y=estMean))+
  geom_boxplot()+
  labs(y="Average Level-2 Factor Variance",
       title="LEVEL-2 FACTOR VARIANCE by ICC of Latent Variables",
       subtitle="SE Estimates")+
  facet_wrap(.~ICC_LV)
...
kable(c, format='html', digits=3,
      caption="Summary Indices of LEVEL-2 FACTOR VARIANCE by ICC of Latent Variables") %>%
  kable_styling(full_width = T)

```

## SE of Level-2 Factor Variances by Estimation Method and Sample Sizes
...
print(xtable(c1, digits = 3,align=c("l", "l", "l", rep("r",9)),
             ...
             caption="Mean Level-2 Factor Variance, Relative Bias, and RMSE by Estimation Method",
             label="tb:fct"),
