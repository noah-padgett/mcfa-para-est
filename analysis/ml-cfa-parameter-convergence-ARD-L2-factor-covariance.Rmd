---
title: "Average Relative Difference Among Parameter Estimates: Level-2 Factor Covariance"
date: "2020-06-10"
...
wide_res <- filter(wide_res, Parameter == "psiB12")
...
p <- ggplot(ard.est, aes(x=Comparison, y=ARD)) +
  ...
  labs(y="Average Relative Difference",
       x=NULL,
       title="ARD: Level-2 Factor Covariance")+
  theme_bw()+
